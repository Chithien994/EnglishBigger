...
public class Constants {
    ...
    public static final int INSERT_VOCABULARY = 3;
    public static final int EDIT_VOCABULARY = 4;
    public static final int GET_VOCABULARY = 5;
    public static final int BACKUP_VOCABULARY = 6;
    public static final int BACKUP_TOPIC = 7;
    public static final int DELETE_TOPIC = 8;
    public static final int GET_NAME_TOPIC = 9;
    public static final int GET_TOPIC = 10;
    public static final int GET_TOPIC_FRIENDS = 11;
    public static final int GET_ALL_TOPIC = 12;
...
//    public static final String TOPIC_URL = "http://hidev.top/englishbigger/api/topic/";
//
//    //Get all topic
//    public static final String ALL_TOPIC_URL = "http://hidev.top/englishbigger/api/topic/all.php";
//
//    //Get topic of fiends
//    public static final String TOPIC_OF_FRIENDS_URL = "http://hidev.top/englishbigger/api/topic/friends.php";
//
//    //Backup topic
//    public static final String BACKUP_TOPIC_URL = "http://hidev.top/englishbigger/api/topic/backup.php";
//
//    //Backup vocabulary
//    public static final String BACKUP_VOCABULARY_URL = "http://hidev.top/englishbigger/api/vocabulary/backup.php";
//
//    //Update topic
//    public static final String UPDATE_URL = "http://hidev.top/englishbigger/api/topic/update.php";
//
//    //Delete topic
//    public static final String DELETE_URL = "http://hidev.top/englishbigger/api/topic/delete.php";
//
//    //Used to register account
//    public static final String USER_URL = "http://hidev.top/englishbigger/api/users/";
//
//    //Used to get account information
//    public static final String USER_INFO_URL = "http://hidev.top/englishbigger/api/usersinfo/";
//
//    //Used to add, edit, delete, or retrieve all vocabulary in each topic
//    public static final String VOCABULARY_URL = "http://hidev.top/englishbigger/api/vocabulary/";
//
//    //Use to update from learned
//    public static final String LEARNED_URL = "http://hidev.top/englishbigger/api/vocabulary/learned.php";
    ...
    public static final String CHECK_UPDATE_URL = "http://mybigger.ga/api/check/version/";

    //FEEDBACK URL

    public static final String FEEDBACK_URL = "http://mybigger.ga/api/feedback/";

    //CHECK UPDATE URL

    public static final String POST_TOKEN_FIREBASE_URL = "http://mybigger.ga/api/users/firebase/";
